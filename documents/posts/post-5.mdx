...
summary: 'A full-stack SaaS project with authentication and payments.'
date: 2023-05-02
...
<br />
In this project, my goal was to build a fully serverless SaaS web-app with `authentication`
and payments — the two vital organs of any business.
<br />
My implementation is opinionated (as you'll see), and intended to serve as a starting
point for new SaaS ideas in the future. Here's what's included:
<br />
You can view the example at https://saas-starter-stack.com/app/ and the source on
[GitHub](https://github.com/pixegami/saas-starter). In this post, I'll be reflecting
on my choices and experience for each of the above features.
